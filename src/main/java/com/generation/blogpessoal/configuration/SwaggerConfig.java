...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
        ...
        return new OpenAPI()
				...
				.contact(new Contact()
					.name("Israel Igarashi")
					.url("https://www.linkedin.com/in/israel-igarashi")
					.email("igarashiisrael@icloud.com")))
				.externalDocs(new ExternalDocumentation()
					.description("Github - Repositório pessoal")
					.url("https://github.com/igarashiisrael"));
	}
